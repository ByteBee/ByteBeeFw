...
namespace ByteBeeTests.Numerics.TrigTests
{
    public sealed class TestTrigFunc
    {
        ...
        [TestCase(Math.PI / 2, 1)]                  // 90°
        [TestCase(Math.PI / 1, 0)]                  // 180°
        public void TestSine(double theta, double expected)
        {
            Trig.Sin(theta)
                .Should().BeApproximately(expected, Bee.Math.Epsilon);
        }
        ...
        [TestCase(Math.PI / 2, 0)]                  // 90°
        [TestCase(Math.PI / 1, -1)]                 // 180°
        public void TestCosine(double theta, double cos)
        {
            Trig.Cos(theta)
                .Should().BeApproximately(cos, Bee.Math.Epsilon);
        }
        ...
        [TestCase(Math.PI / 3, 1.732050808)]
        [TestCase(Math.PI / 1, 0)]
        public void TestTangent(double theta, double tan)
        {
            Trig.Tan(theta)
        ...
        [TestCase(Math.PI / 3, 2)]
        [TestCase(Math.PI / 1, -1)]
        public void TestSecant(double theta, double expected)
        {
            Trig.Sec(theta)
                .Should().BeApproximately(expected, Bee.Math.Epsilon);
        }
        ...
        [TestCase(Math.PI / 3, 1.1547005383793)]
        [TestCase(Math.PI / 2, 1)]
        public void TestCosecant(double theta, double expected)
        {
            Trig.Csc(theta)
                .Should().BeApproximately(expected, Bee.Math.Epsilon);
        }
        ...
        [TestCase(Math.PI / 3, 0.5773502691896)]
        [TestCase(Math.PI / 2, 0)]
        public void TestCotangent(double theta, double expected)
        {
            Trig.Cot(theta)
                .Should().BeApproximately(expected, Bee.Math.Epsilon);
        }
