...
namespace ByteBeeTests.GuardClause
{
    ...
    public sealed class TestAgainstZero
    {
        ...
        {
            const int sut = 0;
            void PerformTest() => Guard.Against.Zero(sut, "int was 0");
        ...
        {
            const short sut = 0;
            void PerformTest() => Guard.Against.Zero(sut, "short was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const long sut = 0;
            void PerformTest() => Guard.Against.Zero(sut, "long was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const float sut = 0;
            void PerformTest() => Guard.Against.Zero(sut, "float was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const double sut = 0;
            void PerformTest() => Guard.Against.Zero(sut, "double was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const decimal sut = 0;
            void PerformTest() => Guard.Against.Zero(sut, "decimal was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        public void When_StructIsZero_Then_ShouldFail()
        {
            ...
            void PerformTest() => Guard.Against.Zero(sut, "struct was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
