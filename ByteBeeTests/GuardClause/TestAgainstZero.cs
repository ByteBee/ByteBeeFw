...
namespace ByteBeeTests.GuardClause
{
    ...
    public sealed class TestAgainstZero
    {
        ...
        {
            const int sut = 0;
            void PerformTest() => Guard.AgainstZero(sut, "int was 0");
        ...
        {
            const short sut = 0;
            void PerformTest() => Guard.AgainstZero(sut, "short was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const long sut = 0;
            void PerformTest() => Guard.AgainstZero(sut, "long was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const float sut = 0;
            void PerformTest() => Guard.AgainstZero(sut, "float was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const double sut = 0;
            void PerformTest() => Guard.AgainstZero(sut, "double was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        {
            const decimal sut = 0;
            void PerformTest() => Guard.AgainstZero(sut, "decimal was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
        ...
        public void When_StructIsZero_Then_ShouldFail()
        {
            ...
            void PerformTest() => Guard.AgainstZero(sut, "struct was 0");
            Assert.Throws<ArgumentException>(PerformTest);
        }
